...
\newcommand{\myauthorwithexistingtitles}{\myauthor{}, BSc}  %% including
                                ...
                                %% (BSc, MSc, ...)
\newcommand{\mytitle}{Advanced excitation and spectroscopy schemes of single quantum dots}  %% also used for PDF metadata (hyperref)
...
\input{template/declaration_JKU}  %% Statutory Declaration
...
\include{chapters/quantum-dot}
\include{chapters/methods}
\include{chapters/chirp}
\include{chapters/fabry-perot}
\include{chapters/summary-outlook}
...
\chapter{Acronyms}
\begin{acronym}[TDMA]
	\acro{BSM}{Bell state measurement}
	\acro{QD}{quantum dot}
