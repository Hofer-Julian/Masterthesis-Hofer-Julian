...
In this subsection, light beams are described by the wave picture according to. They fulfil the Maxwell equations and therefore the electric field $\mathbf{E}(\mathbf{r},t)$  the wave equation
\begin{equation}
...
\subsection{Mode and Mode-Matching}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{figures/fabry-perot/resonator-mode-matching}
	\caption{Gaussian beam and resonator mirrors}
	\label{fig:resonator-mode-matching}
\end{figure}
