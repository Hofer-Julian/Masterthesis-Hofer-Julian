...
The conversion therefore the inversion and attenuation of the signal.
...
The piezoelectric actuator moves step-wisely one of the mirrors and after every step the output is recorded with the \ac{CCD}.
...
The intensity with and without \ac{FPI} were compared in order to calculate its transmission at the peak of its modes, leading to $T_{peak}=\SI{5}{\percent}$.
...
\begin{equation}
1/F_t = \left[(1/F)^2+(1/F_q)^2+(1/F_i)^2\right].
\end{equation}
...
\begin{figure}[H]
	...
	\caption{Finestructure measurement of biexcition-exciton decay emission of QD in sample AS208.
...
From the performed measurements and the considerations about the stability can be deduced that with mirrors of correct geometry fine details of \ac{QD} emission can be resolved.
