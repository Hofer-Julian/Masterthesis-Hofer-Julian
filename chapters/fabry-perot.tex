...
\todo{Goal:Resolve QD emission line.}
...
Commonly, light is sent through the \ac{FPI}. Therefore the following sections will use the Airy distribution $A'_{trans}$.
\begin{equation}
\label{eq:A-trans}
...
\begin{figure}[H]
	...
	\caption{Finestructure measurement of biexcition of a GaAs QD by passing thorugh FPI and sweeping the mirror distance.
	Ground mirror distance $l$ was \SI{2}{\milli \meter}.}
