...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.48\textwidth}
		...
		\caption{XX decay cascade without X degeneracy because of fine structure splitting.\\}
	...
	\begin{subfigure}[b]{0.48\textwidth}
		...
		In the image the effect of the linear polarization of the fine structure components is visible.}
		\label{fig:fss-pol}
	\end{subfigure}
	\caption{FSS~\cite{schimpf_towards_2017}}
	\label{fig:fss}
\end{figure}
