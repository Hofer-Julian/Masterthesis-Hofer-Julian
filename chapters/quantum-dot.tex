...
The Al reacts with Al$_{0.4}$Ga$_{0.6}$As, which leads into nanoholes etched into the surface.
...
\begin{figure}[H]
	...
	\caption{Biexciton-exciton cascade in a QD.~\cite{huber_gaas_2019}}
...
As our team is interested in extracting entangled and indistinguishable X/XX photon pairs, above-band is often not the best exciting technique for GaAs \acp{QD}.
