...
The Hamiltonian of equation~\eqref{eq:hamiltonian} can the by described in the bases $\{\ket{+1},\ket{-1}\}$
\begin{equation}
\mathcal{H}_{ex}=
\begin{pmatrix}
...
The new basis can be found by diagonalising $\mathcal{H}_{ex}$, described by $\frac{1}{\sqrt{2}}(\ket{+1}+\ket{-1})$ and $\frac{1}{\sqrt{2}}(\ket{+1}-\ket{-1})$.
