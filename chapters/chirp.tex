...
Afterwards, a signal was measured where an additional pulse expander inserted as discussed in section~\ref{sec:pulse-expander} and sketched in figure~\ref{fig:setupflat}.
