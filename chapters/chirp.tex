...
\end{equation}
Here $\langle \rangle$ denotes averaging over fast oscillations of the electric field.\todo{ Doesn't the phase drop out by taking the magnitude? In the next formula, I see no averaging over a time or a probability distribution.\textbf{See page 460 in citation.}}
...
\end{figure}
\todo{Put citations also into the main text \textbf{Does it make sense here? The picture is the only thing I took from Wikipedia}}
...
In fact, the frequency chirp rate $a_{gauss}$ introduced in equation~\eqref{eq:phi-gauss} can be put into relation with it by:~\cite{orfanidis_electromagnetic_2002}\todo{1) What chirp parameter do I need for our dots?\\
	2) How do I define this chirp with the expander?\\
	3) How do I measure this chirp? \\
\textbf{2) and 3) should be fine now, how about 1)?} }
\begin{equation}
