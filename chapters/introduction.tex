...
Quantum key distribution \acs{QKD} \acused{QKD} under the E$91$ protocol can be implemented by exchanging entangled photons over the quantum networks and then generate a shared encryption key.
